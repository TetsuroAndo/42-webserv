...
run_test "test/static_file_test/config_autoindex_off.yaml" "Autoindex Off (Forbidden)" "/no_autoindex_dir/" "403 Forbidden" "Forbidden" || exit 1

# 5. File not found
run_test "test/static_file_test/config_basic_get.yaml" "File Not Found" "/non-existent-file.txt" "404 Not Found" "Not Found" || exit 1
