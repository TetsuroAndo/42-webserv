...
void Socket::setRecvBuffer(const std::string &str) {
	this->recvBuffer = str;
}

void Socket::setSendBuffer(const std::string &str) {
	this->sendBuffer = str;
}
...
const std::string &Socket::getRecvBuffer() {
	return this->recvBuffer;
}

const std::string &Socket::getSendBuffer() {
